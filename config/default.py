...
# 资源池业务ID
BK_CMDB_RESOURCE_POOL_BIZ_ID = int(os.getenv("BK_CMDB_RESOURCE_POOL_BIZ_ID", 10000)) or 10000
...
# IAM网关名称
BK_IAM_APIGW_NAME = "bk-iam"
# IAM网关
BK_IAM_APIGATEWAY_URL = BK_API_URL_TMPL.format(api_name=BK_IAM_APIGW_NAME) + "/" + env.ENVIRONMENT
...
# 多租户业务集ID
try:
    TENANT_BLUEKING_SCOPE_ID = int(os.getenv("TENANT_BLUEKING_SCOPE_ID", 1))
except (TypeError, ValueError):
    TENANT_BLUEKING_SCOPE_ID = 1
